...
namespace Mrówka
{
    class Automat
    {
        ...
        private foMrówka adres;
        private ComboBox lista_wzorców;
        private List<Mrówki> mrówki;

        public Automat(foMrówka adres_formy, ComboBox wzory)
        {
            adres = adres_formy;
            lista_wzorców = wzory;
        ...
        public Automat(int sze, int wys, int wielkość, foMrówka adres_formy, ComboBox wzory)
        {
            mrówki = new List<Mrówki>();
            szerokość = sze;
            wysokość = wys;
